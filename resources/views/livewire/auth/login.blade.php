<div>
    ...
    <div class="flex flex-col min-h-screen items-center justify-center p-4 sm:p-6">
        <form wire:submit.prevent="login"
            ...
            <h1 class="font-bold text-black text-xl sm:text-2xl leading-tight text-center sm:text-left">Selamat Datang Kembali</h1>
            ...
            <div>
                <div
                    ...
                    <div class="flex shrink-0">
                        <img src="{{ asset('assets/images/icons/sms.svg') }}" alt="icon" class="w-5 h-5 sm:w-6 sm:h-6">
                    </div>
                    <input type="email" wire:model.lazy="email"
                        ...
                        placeholder="Tulis email kamu" autofocus>
                </div>
            ...
            <div>
                <div x-data="{ showPassword: false }"
                    ...
                    <div class="flex shrink-0">
                        <img src="{{ asset('assets/images/icons/lock.svg') }}" alt="icon" class="w-5 h-5 sm:w-6 sm:h-6">
                    </div>
                    ...
                    <button type="button" @click="showPassword = !showPassword" class="reveal-password flex shrink-0">
                        <img x-show="!showPassword" src="{{ asset('assets/images/icons/eye.svg') }}" alt="show" class="w-5 h-5 sm:w-6 sm:h-6">
                        <img x-show="showPassword" src="{{ asset('assets/images/icons/eye-slash.svg') }}" alt="hide" class="w-5 h-5 sm:w-6 sm:h-6" style="display: none;">
                    </button>
                </div>
